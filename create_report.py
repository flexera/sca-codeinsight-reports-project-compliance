...
logging.basicConfig(format='%(asctime)s,%(msecs)d %(levelname)-8s [%(filename)s:%(lineno)d] %(message)s', datefmt='%Y-%m-%d:%H:%M:%S', filename="_project_compliance_report.log", filemode='w',level=logging.DEBUG)
...
def main():
	...
	reportName = "Project Compliance Report"
